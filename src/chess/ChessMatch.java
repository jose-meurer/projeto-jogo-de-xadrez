...
public class ChessMatch {
    ...
    public List<Piece> getCapturedPieces() {
        return Collections.unmodifiableList(capturedPieces); // Deixa a lista apenas para leitura, se tentar altera o codigo quebra
    }
    ...
    public ChessPiece replacePromotedPiece(String type) {
        ...
        check = testCheck(currentPlayer); // fix falso check
    ...
    private void nextTurn() {
        ...
        if (currentPlayer == Color.WHITE) { //Quando for branco muda de turno
            turn++;
        }
    }
